...
- 📝 Apply to jobs
- 👤 Profile management
- 📄 Upload resume / portfolio (if supported)

### For Recruiters
- 📢 Post and manage job listings
- 🗂️ View applications
- 📊 Dashboard for posting analytics (optional)
...
🚀 **TaloSync Job Portal**  
🔗 Live: https://talosync.onrender.com/
...
MohammedTharick25 — Developer & Maintainer
